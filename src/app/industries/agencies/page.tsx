  ...
  return (
    <main className="bg-white">
          ...
          >
            <motion.div variants={itemVariants}>
              <CaseStudyCard
                ...
                challenge="Growing demand for services, but business development fell to the principals. Cycle of feast-and-famine pipeline meant uneven cash flow and team utilization."
                resultMetric="New Clients Signed"
                resultValue="8 net new clients"
                caseStudyHref="/case-studies/agency-partnership-pipeline"
              />
            </motion.div>
            <motion.div variants={itemVariants}>
              <CaseStudyCard
                clientType="Consulting Firm"
                challenge="Wanted to scale consulting practice but needed to build partnership and referral pipeline. Internal sales team was minimal, resources limited."
                resultMetric="Pipeline Built"
                resultValue="$2.1M in qualified"
                caseStudyHref="/case-studies/agency-partnership-pipeline"
              />
            </motion.div>
          </motion.div>
      ...
      <CTASection
        ...
        secondaryButtonText="View Agency Case Studies"
